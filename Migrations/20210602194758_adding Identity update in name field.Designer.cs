...
namespace CrudAPIWithRepositoryPattern.Migrations
{
    ...
    [Migration("20210602194758_adding Identity update in name field")]
    partial class addingIdentityupdateinnamefield
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrudAPIWithRepositoryPattern.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CrudAPIWithRepositoryPattern.Models.PersonSkills", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CrudAPIWithRepositoryPattern.Models.PersonSkills", b =>
                {
                    b.HasOne("CrudAPIWithRepositoryPattern.Models.Person", "Person")
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CrudAPIWithRepositoryPattern.Models.Skill", "Skill")
                        .WithMany()
            ...
            modelBuilder.Entity("CrudAPIWithRepositoryPattern.Models.Skill", b =>
                {
                    b.HasOne("CrudAPIWithRepositoryPattern.Models.Person", null)
                        .WithMany("Skills")
                        .HasForeignKey("PersonID");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CrudAPIWithRepositoryPattern.Models.ApplicationUser", null)
                        .WithMany()
